...
/**
 * Servlet implementation class ReimViewPendServlet
 */
@WebServlet("/ReimViewPendServlet")
public class ReimViewPendServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private PostgresConnector connector;
	private ReimbursementService reimbursementService;

	public ReimViewPendServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ReimViewPendServlet app = new ReimViewPendServlet();
		List<Reimbursement> reimbursements = app.reimbursementService.getPendAll();
